<div>
    <form action="{{url('AdminController/createProduct')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="descriptionProductInput" name="description" aria-describedby="nameProductHelp">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary" onclick="return confirm('Product created')">Submit</button>
    </form>
</div>
